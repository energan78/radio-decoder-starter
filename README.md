...
Многофункциональный сервис для анализа радиосигналов с помощью искусственного интеллекта.  
Поддерживает классификацию сигналов, самообучение, работу с датасетами RadioML, онлайн и офлайн распознавание речи, детектор аномалий, геоклассификацию, анализ эмоций, а также удобный веб-интерфейс для управления.
